...
class FocusedExtractor:
    def __init__(self):
        self.base_dir = Path("c:/Users/91916/OneDrive/Desktop/hilabs/HiLabsAIQuest_ContractsAI")
        self.debug_dir = Path("debug/focused")
        self.debug_dir.mkdir(parents=True, exist_ok=True)
        
        # Target files
        self.contract_path = self.base_dir / "Contracts/TN/TN_Contract2_Redacted.pdf"
